...
app.get('/auth/amazon', (req, res) => {
  ...
  const authUrl = `${AMAZON_AUTH_URL}?client_id=${AMAZON_CLIENT_ID}&scope=cpc_advertising:campaign_management&response_type=code&redirect_uri=${AMAZON_REDIRECT_URI}&state=${state}`;
